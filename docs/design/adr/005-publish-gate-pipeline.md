...
an enterprise feature, reflecting the higher trust requirements and larger
...
- Prompt-injection scanning addresses a real and documented threat for this
  artifact class
- Clear separation between OSS and enterprise value

**Negative:**
- LLM review adds latency and API cost to every enterprise PR
